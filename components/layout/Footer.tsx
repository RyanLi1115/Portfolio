      ...
      <div className="container mx-auto px-md h-full">
        <div className="flex flex-col h-full">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between flex-1">
            {/* 左侧：网站名称展示 */}
            <div className="text-center md:text-left mb-lg md:mb-0">
              <h2 className="text-white text-6xl font-display">
                Ryan Yiran Li 
                <br />
                Portfolio
              </h2>
          ...
          {/* 下半部分：社交媒体链接区域 */}
          <div className="flex justify-end items-end pb-2xl">
            <div className="flex space-x-lg">
              ...
              {/* GitHub */}
              <a 
                href="https://github.com/RyanLi1115" 
                target="_blank" 
                rel="noopener noreferrer" 
                className="text-white hover:text-gray-300 transition-all duration-300 hover:scale-110 transform cursor-pointer"
              >
